...
public class MovieResolutionRenderer implements TableCellRenderer, ListCellRenderer {
    ...
    public MovieResolutionRenderer() {
    ...
    public Component getListCellRendererComponent(final JList list, Object value, final int index, final boolean isSelected, final boolean cellHasFocus) {
        if (value instanceof MovieResolution)
            value = ((MovieResolution) value).getLabel();
